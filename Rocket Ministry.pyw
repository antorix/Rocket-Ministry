...
if path.exists("main.py"):
    ...
    tkinter.messagebox.showinfo(
        ...
        "Поздравляем, вы почти у цели! Сейчас будут загружены файлы программы. Закройте это окно и подождите несколько секунд. Затем запустите программу щелчком по иконке на рабочем столе.")
