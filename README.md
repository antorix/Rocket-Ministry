...
Просто введите в соответствующих графах в разделе *Отчет* отрицательные значения для коррекции ошибки. Например, `-1` час или `-3` видео. Можно даже `-0:12` (минус 12 минут).
