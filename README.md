*Внимание! Нужна помощь? Сначала посмотрите раздел [вопросов и ответов](https://github.com/antorix/Rocket-Ministry/blob/master/README.md#часто-задаваемые-вопросы). Решение вашей проблемы находится там с вероятностью 99% 😊*
...
3. Дайте разрешение на доступ к памяти.
4. Закройте приложение и снова откройте его.
5. Нажмите на большую круглую кнопку на главном экране.
6. Выберите *Run local project* → *Rocket Ministry*.
