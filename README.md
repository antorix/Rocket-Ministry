...
Самый быстрый способ запустить Rocket Ministry – нажать на большую круглую кнопку на главной странице QPython.
...
## Я запустил программу, но вместо нее вижу много белого текста на черном фоне, последние слова: connection refused
...
## Я скачал apk-файл и установил QPython, но в нем нет программы, где ее искать?
