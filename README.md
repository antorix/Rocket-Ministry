...
В контекстном меню файла main.py можно выбрать запуск по умолчанию в Python 3.10 и создать для него иконку на рабочем столе. Тогда можно быстро запускать с рабочего стола одним кликом. Если вам нужна красивая PNG-иконка для ярлыка, ее можно взять [здесь](https://iconarchive.com/show/captiva-icons-by-bokehlicia/rocket-icon.html).
