...
Используйте квартиры-заглушки с номерами, начинающимися на 0, например 01. В таких квартирах никто не живет, зато они заполняют места в раскладке, требуемые для сортировки. Им можно сразу присваивать отказы. Пример:
...
В этом подъезде при 5 этажах всего 18 квартир, потому что на первых двух этажах – по 3 квартиры вместо 4. Мы создали две квартиры-заглушки 03 и 06, и поэтажный вид восстановлен. Такие квартиры сортируются по значимой цифре с отсечением нолей.
