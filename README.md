...
Да, в Play Маркете доступна версия QPython 3L, а файлы Rocket Ministry можно скачать отдельно и скопировать в папку `qpython/projects3` на вашем устройстве. Но я все же рекомендую версию QPython 3S, потому что она новее и у нее больше возможностей.
