...
**Отдельные контакты**. Отдельный контакт существует как бы сам по себе, у него можно свободно изменять адрес (в его деталях есть отдельный пункт для этого). Также учтите, что при удалении участка вместе с ним удаляются и все живущие на нем контакты-квартиры, что логично. Однако программа при удалении участка автоматически создает их отдельные копии, так что с точки зрения пользователя все интересующиеся как бы продолжают «жить» и после сдачи участка, пока не будут удалены вручную.
