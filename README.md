...
### Я забыл выключить таймер, и в отчет внеслось слишком много времени (или другие неверные данные отчета), как это исправить?

Просто введите в соответствующих графах в разделе *Отчет* отрицательные значения для коррекции ошибки. Например, `-1` час или `-3` видео. Можно даже `-0:12` (минус 12 минут). Все изменения отчета фиксируются в журнале, так что можно отследить и исправить любую ошибку.
