...
### Я записал в отчет ошибочное время или другие данные, как это исправить?

Просто введите в соответствующих графах в разделе *Отчет* отрицательные значения для коррекции ошибки. Например, `-1` час или `-3` видео. Можно даже `-0:10` (минус десять минут).
