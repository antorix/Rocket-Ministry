Приложение для служения с мощными функциями, но с акцентом на скорость работы, с открытым исходным кодом, функциями безопасности и поддержкой Android, Windows и Linux.
